...
fun insert(entity: Any, con: Connection? = null, updateAutoGenValues: Boolean = true) =
    execInsertOrUpdate(entity, null, con, updateAutoGenValues, "INSERT INTO %s (", "") { _, sb, params ->
        sb.append(") VALUES (")
...
private fun addPropToBindParams(entity: Any, p: KProperty<*>, bindParams:ArrayList<Any?>) {
    @Suppress("UNCHECKED_CAST")
    var value = when (p) {
