...
/** Generates LIKE condition that checks that column contains [text].
 * Should be called on a string that represents column name for which LIKE condition needs to be specified.
 * ATTENTION! Case-sensitivity of LIKE varies across different RDBMS.
...
/** Generates LIKE condition that checks that column begins with [text].
 * Should be called on a string that represents column name for which LIKE condition needs to be specified.
 * ATTENTION! Case-sensitivity of LIKE varies across different RDBMS.
...
/** Generates LIKE condition that checks that column finishes with [text].
 * Should be called on a string that represents column name for which LIKE condition needs to be specified.
 * ATTENTION! Case-sensitivity of LIKE varies across different RDBMS.
 * For guaranteed case-insensitive comparison use [finishesWithIgnoreCase].
 * For case-sensitive comparison check documentation of target RDBMS.
 * @param text string that will be preceded with %. % and _ wildcards will be escaped.
 * @return [Like] object to be passed as a parameter to [Sql] string. */
infix fun String.finishesWith(text: String) =
    Like(this, false, '%', text, null)

/** Generates case-insensitive LIKE condition that checks that column contains [text].
...
/** Generates case-insensitive LIKE condition that checks that column begins with [text].
 * Both column and [text] are cast to lowercase to guarantee case-insensitivity across all RDBMS.
 * Should be called on a string that represents column name for which LIKE condition needs to be specified.
...
/** Generates case-insensitive LIKE condition that checks that column finishes with [text].
 * Both column and [text] are cast to lowercase to guarantee case-insensitivity across all RDBMS.
 * Should be called on a string that represents column name for which LIKE condition needs to be specified.
 * @param text string that will be cast to lowercase and preceded with %. % and _ wildcards will be escaped.
 * @return [Like] object to be passed as a parameter to [Sql] string. */
